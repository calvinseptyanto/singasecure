...
export default function LLMResponse({ content }) {
  ...
  const handleClarify = async () => {
    ...
    // Simulate delay for dummy explanation
    await new Promise((resolve) => setTimeout(resolve, 1500));

    // Set a dummy explanation text
    setExplanation(
      `This is a dummy explanation for the selected text: "${selectedText}". In a real scenario, this explanation would be generated by an LLM based on the context of the content.`
    );
